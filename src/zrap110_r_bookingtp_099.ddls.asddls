...
@ObjectModel.sapObjectNodeType.name: 'ZRAP110_Booking_099'
define view entity ZRAP110_R_BOOKINGTP_099
  as select from ZRAP110_ABOOK099 as Booking
  association to parent ZRAP110_R_TRAVELTP_099 as _Travel on $projection.TravelID = _Travel.TravelID
